...
Ajax를 이용하여 GET 메소드로 status api를 3초마다 요청을 보내서 주문 내역을 계속 확인하다가 완료 버튼을 누르면 <br />
...
[image11]
자동으로 puller가 해당 코드를 Git에서 받아와 볼륨에 저장하고, 저장된 코드는 웹 서버에 공유 되어있기 때문에 서비스에 바로 적용이 가능합니다.  <br />
